...
abstract class RoomContactDatabase : RoomDatabase() {
    ...
    companion object {
         ...
         */
        @Volatile
        private var INSTANCE: RoomContactDatabase? = null
         ...
         */
        fun getInstance(context: Context): RoomContactDatabase {
            ...
            synchronized(this) {
                ...
                if (instance == null) {
                    instance = Room.databaseBuilder(
                        ...
                        RoomContactDatabase::class.java,
                        "room_contact_history_database"
                    )
